...
def draw_board():
	screen.fill(white)
	pygame.draw.line(screen, white, (0, gameMargin), (screen_width, gameMargin), 2)
...
class paddle():
	...
	def move(self):
		...
		if key[pygame.K_UP] and self.rect.top > gameMargin:
	...
	def ai(self):
		...
		#move up
		if self.rect.centery > pong.rect.bottom and self.rect.top > gameMargin:
...
class ball():
	...
	def move(self):
		...
		#check collision with top gameMargin
		if self.rect.top < gameMargin:
			self.speed_y *= -1
